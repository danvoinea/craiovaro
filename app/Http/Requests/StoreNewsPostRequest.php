...
class StoreNewsPostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('news_posts')->where(fn ($query) => $query->where('category_slug', $this->input('category_slug')))],
            'category_slug' => ['required', 'string', 'max:100', 'regex:/^[a-z0-9-]+$/'],
